...
class DataMapper
{
    ...
    public static List<Category> LoadCategories()
    {
        ...
        foreach (var line in dataLines)
        {
            ...
            var name = args[1];
            var postIds = args[2].Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray();
    ...
    public static List<User> LoadUsers()
    {
        ...
        foreach (var line in dataLines)
        {
            ...
            {
                var postIds = args[3].Split(',').Select(int.Parse).ToArray();
    ...
    public static void SaveUsers(List<User> users)
    {
        ...
        foreach (var user in users)
        {
            ...
            string line = string.Format(userFormat, user.Id, user.Name, user.Password, string.Join(",", user.PostIds));
    ...
    public static List<Post> LoadPosts()
    {
        ...
        foreach (var line in dataLines)
        {
            ...
            {
                repliesIds.AddRange(args[5].Split(';').Select(int.Parse));
            }
